    ...
    try {
        ...
        if (error.code === 'ENOENT') {
            ...
            const defaultDb = {
                ...
                scrollingText: { text: "Önemli duyurular yakında burada olacak!" }, // Metni bir obje içine aldım
                mainSponsorPopup: { // Yeni eklenen popup alanı
                    ...
                    link: "#",
                    active: true // Pop-up'ın aktif olup olmadığını belirler
                }
            };
